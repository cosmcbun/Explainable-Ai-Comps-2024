...
cat_pillow = Image.open(cat_file)
cat_tensor = transform_image(cat_file)
print(cat_tensor)
...
explainer = anchor_image.AnchorImage('../../../animal_images',transform_img_fn=transform_images, n = 1000)
...
segments, explanation = explainer.explain_instance(cat_pillow, predict)
...
tensors = transform_images(paths)




probs = predict(tensors)
